...
10. [Checkers](CHECKERS.md) 与 [Evaluation](EVALUATION.md)：理解 v0.10.0 已发布 release 的 checker registry、cross-check/gap reports、deterministic eval，以及这些输出为什么只是 review context。
...
- [Reviewable workflows](WORKFLOWS.md)：v0.9.0 workflow CLI、draft proposal、review handoff 和 review-context 边界。
- [Review handoffs](REVIEW_HANDOFFS.md)：workflow/operator handoff、scanner、export dry-run 和非权威边界。
